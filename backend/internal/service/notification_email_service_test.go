...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "viz2ai", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "viz2ai", "https://example.com/reset", "en-US"))
