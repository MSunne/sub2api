...
func load(allowMissingJWTSecret bool) (*Config, error) {
	...
	viper.AddConfigPath("/etc/viz2ai")
...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "viz2ai")
	...
	viper.SetDefault("database.dbname", "viz2ai")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "viz2ai:")
