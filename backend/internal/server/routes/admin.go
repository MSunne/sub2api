...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/audits", h.Admin.Usage.ListAuditLogs)
		usage.GET("/audits/by-request/:request_id", h.Admin.Usage.GetAuditLogByRequestID)
		usage.GET("/audits/:id/body/:role", h.Admin.Usage.GetAuditLogBody)
		usage.GET("/audits/:id", h.Admin.Usage.GetAuditLog)
		usage.GET("/:id/audit", h.Admin.Usage.GetAuditLogByUsageID)
		usage.GET("/:id/audit/body/:role", h.Admin.Usage.GetAuditLogBodyByUsageID)
