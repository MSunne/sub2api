...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	requestAuditRepository := repository.NewRequestAuditRepository(db)
	requestAuditService := service.NewRequestAuditService(requestAuditRepository)
	usageHandler := handler.ProvideUsageHandler(usageService, apiKeyService, requestAuditService)
	...
	adminUsageHandler := handler.ProvideAdminUsageHandler(usageService, apiKeyService, adminService, usageCleanupService, requestAuditService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, requestAuditService, redisClient)
